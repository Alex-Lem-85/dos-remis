      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex justify-center mb-6">
            {" "}
            {/* Center the button and add margin bottom */}
            <Button
              asChild
              size="lg"
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Comptez 1 à 2 h au total avec les formalités et la
                        surveillance
                      </p>
                    </div>
                  </li>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Elle est importante pour évaluer le risque de
                        chronicisation des douleurs et vous orienter vers les
                        bons professionnels (RDV au cabinet Anesthau 7)
                      </p>
                    </div>
                  </li>
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Prescription de 5 séances avec réévaluation à la 4ème
                        séance
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-gray-600">
                        En cas d'arrêt de travail, il n'est pas nécessaire
                        d'attendre la disparition des symptômes pour reprendre.
                        La reprise précoce améliore le pronostic
                      </p>
                    </div>
                  </li>
                </ul>
