...
const steps = [
  ...
  {
    title: "On vous soulage",
    description: "Infiltration ciblée sous échographie",
  },
  {
    title: "On vous suit",
...
const newsItems = [
  {
    title: "On commence a infiltrer les médias ;-)",
    description:
  ...
  {
    title:
      "Soirée interprofessionnelle : construire ensemble une filière lombalgie d’excellence",
    description:
